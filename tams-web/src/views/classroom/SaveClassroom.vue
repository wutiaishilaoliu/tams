<template>
  <el-dialog title="新增" width="500px" :close-on-click-modal="false" :close-on-press-escape="false" v-model="dialogVisible" :before-close="handleClose">
...
const submit = () => {
  formRef.value?.validate((valid) => {
    if (valid) {
      ...
      classroomStore.saveClassroom(form.value).then(() => {
